...
// let StateModel = require('../src/models/index').State;
// let CountryModel = require('../src/models/index').Country;
...
//            return CountryModel.create({name: 'Brazil2',alpha2: 'BR2', alpha3: 'BRZ2', un: '0042'}).
//            then(c => {
//                const id = c['id'];
//                return StateModel.create({name: 'Pernambuco2', abbreviation: 'PE2', CountryId: id});
//            });
//         }
//     });
//
